...
export const Admins = props => {
    ...
    const updateuserstatus = async (userobj) => {
        let bodycontent = {
            user_id : userobj.id,
            status : !userobj.id_active
        }
        alert(JSON.stringify(bodycontent))
        let units = await sendNetworkRequest('/master/updateadminstatus', {}, bodycontent,false)
    ...
    {
      let units = await sendNetworkRequest('/master/fetchadmins', {}, {},false)
