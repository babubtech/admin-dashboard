...
export const RoleMaster = props => {
    ...
    const updateuserstatus = async (userobj) => {
        let units = await sendNetworkRequest('/master/modifyuserrole', {}, userobj,false)
    ...
    {
      let units = await sendNetworkRequest('/master/fetchmasterroles', {}, {},false)
    ...
    return <div className={classes.root}>
      ...
      >
        ...
        <SubHeader title={"Role Master"} buttonText={"Add Role Master"} handleAddOpen={handleClickOpen}/>
