...
export const UserProfileList = props => {
    ...
    return <div className={classes.root}>
        <SubHeader title={"User Profile List"} />
        ...
        <DataTable 
            heading={"User Profile List"}
            className={classes.results}
            orders={dataList}
            header={[{name: "S No"}, {name: "Profile Pic"}, {name: "User Name"}, {name: "Mobile"}, {name: "E-mail"}, {name: "Status"}, {name: "Edit", align: "right"}, {name: "Delete", align: "right"}]}
            dataList={[
                [
                    {
                        componentType: "count",
